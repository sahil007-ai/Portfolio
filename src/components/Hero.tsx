  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full flex flex-col items-center text-center z-10">
        ...
        >
          I build <span className="text-accent">intelligent systems</span>.
        </motion.h1>
        ...
        >
          I&apos;m Sahil — an AI engineer from Nagpur. I sit at the intersection of technical depth and human communication. Let&apos;s build something great.
        </motion.p>
